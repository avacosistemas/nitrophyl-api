package ar.com.avaco.nitrophyl.ws.controller;
...
import ar.com.avaco.nitrophyl.ws.dto.ClienteCompletoDTO;
...
public class MoldesRestController extends AbstractDTORestController<MoldeDTO, Long, MoldeEPService> {
	...
	public ResponseEntity<JSONResponse> updateMolde(@PathVariable("id") Long id, @RequestBody MoldeDTO moldeDTO) throws Exception {
		moldeDTO.setId(id);
	...
	public ResponseEntity<JSONResponse> updateMoldeBocas(@PathVariable("idMolde") Long idMolde, @RequestBody List<MoldeBocaListadoDTO> moldeBocaListadoDTO) throws Exception {		
	...
	public ResponseEntity<JSONResponse> updateMoldeDimensiones(@PathVariable("idMolde") Long idMolde, @RequestBody List<MoldeDimensionListadoDTO> moldeDimensionListadoDTOs) throws Exception {		
